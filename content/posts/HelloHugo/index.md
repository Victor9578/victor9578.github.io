...
slug: hello-hugo
summary: Hugo 入门，以 PaperMod 主题为例进行基本配置，利用 Git 完成备份和部署工作。 # 文章简介 #
author: ["SeerSu"] # 作者 #
date: 2022-02-05T22:08:07+08:00 # 日期 #
cover:
    image: "https://d33wubrfki0l68.cloudfront.net/c38c7334cc3f23585738e40334284fddcaf03d5e/2e17c/images/hugo-logo-wide.svg" # 文章顶图 #
    alt: "Hugo" # 图片名 #
    hidden: true # 文章内显示/不显示 #
categories: [hobby] # 文章分类 #
tags: [hugo, 折腾] # 文章标签 #
...
个人使用的最新部署方案已经单独在[另一篇博客]()中进行详细介绍，以 GitHub 作为代码托管平台，使用 GitHub Action 完成部署。
